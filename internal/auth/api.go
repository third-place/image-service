...
/*
CreateNewSession Create a new user session
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param newSession session to create
@return Session
*/
func (a *DefaultApiService) CreateNewSession(ctx _context.Context, newSession model.NewSession) (model.Session, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
